...
This file contains the main arg parser which stimulates the model training, testing and validation tasks
...
parser.add_argument("--LR_path", type = str, default = '../dataSet/DIV2K/DIV2K_valid_LR_bicubic/X4')
